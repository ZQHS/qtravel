...
import com.qianfeng.bigdata.realtime.flink.streaming.funs.orders.OrdersAggFun.{OrderDetailTimeAggFun, OrderTopNKeyedProcessFun, OrderTrafficTimeWindowFun}
import com.qianfeng.bigdata.realtime.flink.streaming.rdo.QRealTimeDO._
import com.qianfeng.bigdata.realtime.flink.streaming.schema.OrderStatisKSchema
...
/**
 * 旅游订单业务数据的实时统计排名
 * 1、根据productID, traffic维度进行分组，累计orders, maxFee, totalFee, members
 * 2、然后并根据Totalfee排序
 */
object OrdersTopnStatisHandler {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val toTopic = "travel_dm_topn_orders"
