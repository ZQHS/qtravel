...
import com.qianfeng.bigdata.realtime.flink.streaming.funs.orders.OrdersAggFun.{OrderDetailTimeAggFun, OrderDetailTimeWindowFun}
...
/**
 * 旅游订单业务实时计算
 * 1、和OrderAggCacheHandler是一抹一样的，，只是sink到es中而已
 */
