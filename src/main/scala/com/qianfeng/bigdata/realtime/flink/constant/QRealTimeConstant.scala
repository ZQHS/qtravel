package com.qianfeng.bigdata.realtime.flink.constant
...
object QRealTimeConstant {
  //常用的常数
  val COMMON_NUMBER_ZERO:Long = Long.box(0)

  val COMMON_NUMBER_ZERO_INT:Int = Int.box(0)

  val COMMON_NUMBER_ZERO_DOUBLE:Double = Double.box(0.0d)

  val COMMON_NUMBER_ONE:Long = Long.box(1)
  ...
  //redis的配置文件
  val REDIS_CONFIG_PATH = "redis/redis.properties"
  ...
  //页面浏览日志明细数据对应es索引名称
  val ES_INDEX_NAME_LOG_VIEW = "travel_log_userpageview_detail"
